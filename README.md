...
- [GPU Support & Compute Resources](#gpu-support--compute-resources)
- [Features](#features)
- [REST API](#rest-api)
...
For per-agent CLI instructions see [Connecting to AI Agents](#connecting-to-ai-agents) below.
...
Official CLI: [docs.anthropic.com](https://docs.anthropic.com/en/docs/claude-code/getting-started)
...
Official CLI: [cloud.google.com](https://cloud.google.com/gemini/docs/codeassist/cli-getting-started)
...
Official CLI: [github.com/openai/codex](https://github.com/openai/codex)
